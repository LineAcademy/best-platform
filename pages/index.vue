<template>
                    ...
                    <div class="col-md-12 pt--70">
                        <div class="content">
                            <div dir="rtl" class="inner">
                                ...
                                <p class="description">
                                   تقدر في 6 شهور بإذن الله تدخل مجال تصميم المواقع وتعمل من خلاله معرفة كويسة في البرمجة 
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            ...
                                            <div dir="rtl" class="rbt-card-body">
                                                <h4 class="rbt-card-title"><a href="course-details.html"> كورس مودرن جافاسكريبت ما قبل React JS</a>
                                                </h4>
                                                <p class="rbt-card-text">في الكورس هنتعرف علي أهم الحاجات الي تذاكرها في مودرن جافاسكريبت قبل رياكت</p>
                                                <div class="rbt-card-bottom">
                                                    <a class="rbt-btn-link" href="course-details.html"> شوف فديوهات الكورس </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div style="position: relative; padding-bottom: 56.15%; height: 0; overflow: hidden;">
      <iframe 
        ...
        <a href='https://www.youtube.com/embed/Ho5UMChjH2w?autoplay=1'>
          <img src='https://img.youtube.com/vi/Ho5UMChjH2w/hqdefault.jpg' alt='Coffee Recipe Javascript Project'>
          <svg xmlns='http://www.w3.org/2000/svg' width='64' height='64' viewBox='0 0 24 24' fill='none' stroke='#ffffff' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-play-circle'><circle cx='12' cy='12' r='10'></circle><polygon points='10 8 16 12 10 16 10 8'></polygon></svg>
        </a>
        "
        src="https://www.youtube.com/embed/Ho5UMChjH2w" 
        ...
        allowfullscreen>
                                            ...
                                            <div dir="rtl" class="rbt-card-body">
                                                <h4 class="rbt-card-title"><a href="course-details.html">فديو مشروع الطالبة مها ب React JS و Sanity Api</a>
                                                </h4>
                                                <p class="rbt-card-text">مها شخص مجتهد عمل المشروع ب رياكت وريداكس لغتين وكمان دارك ووايت ثيم - فخور ب مها</p>
                                                <div class="rbt-card-bottom">
                                                    <a class="rbt-btn-link" href="course-details.html">أقرء المزيد عن الحكاية </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            ...
                                            <div dir="rtl" class="rbt-card-body">
                                                <h4 class="rbt-card-title"><a href="course-details.html">ماسبقة علي مشروع من 3 صفح كاملة لطلاب جروب رياكت</a>
                                                </h4>
                                                <p class="rbt-card-text">تفاصيل مسابقة علي HTML , CSS , JS لانشاء صفح متجر متجاوبة مع جميع الشاشات وفديو الفائزين</p>
                                                <div class="rbt-card-bottom">
                                                    <a class="rbt-btn-link" href="course-details.html">أقرء المزيد عن المسابقة </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            ...
                                            <div dir="rtl" class="rbt-card-body">
                                                <h4 class="rbt-card-title"><a href="course-details.html">نتائج مسابقة علي مشروع صفحة واحدة HTML , CSS بين طلاب المجموعات</a>
                                                </h4>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center mb--50">
                            <h2 class="title">أهم الكورسات والفديوهات</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center mb--50 mt--50">
                            <h2 class="title">مشاريع الطلاب</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5 rbt-border-gap">
                    ...
                    <div class="col-12 text-center">
                        <a class="rbt-btn btn-gradient hover-icon-reverse" href="#"><span class="icon-reverse-wrapper"><span>كل المشاريع</span></span></a>
                    </div>
                </div>
                <!-- Start Blog Style -->
                ...
                <div class="row g-5 align-items-center mb--30">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="section-title">
                            <h2 class="title">مقالات برمجية</h2>
                        </div>
                    </div>
...
<!-- End Single Card  -->
                    ...
                    <div class="col-12 text-center mt-4">
                        <a class="rbt-btn btn-gradient hover-icon-reverse" href="#"><span class="icon-reverse-wrapper"><span>كل الحكايات</span></span></a>
                    </div>
                </div>
                <!-- End Card Area -->
            </div>
        ...
        <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center mb--50 mt--50">
                            <h2 class="title">حكايات نجاح الطلاب</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
            ...
            <div class="container">
                <div class="row mb--55">
                    <div class="section-title text-center">
                        <span class="subtitle bg-white-opacity">الأنشطة التطوعية</span>
                        <h2 class="title color-white">أحمد شارك في الأنشطة التطوعية</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body text-center">
                                                <h4 class="rbt-card-title"><a target="_blank" href="https://tedxshacom.netlify.app/">مصمم موقع تيدكس الشروق</a></h4>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body text-center">
                                                <h4 class="rbt-card-title"><a href="event-details.html">مصمم موقع تيدكس الشروق</a></h4>
        ...
        <div class="rbt-categories-area bg-color-white rbt-section-gap">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <h2 class="title">أحمد يقدر يقدملك ايه ؟</h2>
                        </div>
                    </div>
                </div>
                <div dir="rtl" class="row g-5 mt--20">
                    <!-- Start Category Box Layout  -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="content">
                                    <h5 class="title">كورس أونلاين أو أوفلاين</h5>
                                    <h6>لو انت محتاج تتعلم فرونت اند او باك اند في مدة تتراوح بين ال 4 ل 6 شهور أنا موجود كلمني</h6>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">أعرف تفاصيل اكتر<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="content">
                                    <h5 class="title">بناء موقع</h5>
                                    <h6>لو انت محتاج تبني موقع لأي نوع بيزنس كلمني حالا</h6>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">أعرف تفاصيل اكتر<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="content">
                                    <h5 class="title">نصائح ومساعدة</h5>
                                    <h6>لو انت محتاج نصيحة في البرمجة او مساعدة في حل اي مشكلة في مشروع كلمني</h6>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">أعرف تفاصيل اكتر<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="content">
                                    <h5 class="title">السيرة الذاتية والأنترفيو</h5>
                                    <h6>لو انت محتاج تعمل سيرة ذاتية كويسة أو تدخل انترفيو زي الشركات عشان تعرف نقط ضعفك كلمني</h6>
                                    <div class="read-more-btn">
                                        <span class="rbt-btn-link">أعرف تفاصيل اكتر<i class="feather-arrow-right"></i></span>
                                    </div>
                                </div>
                ...
                <div class="scroll-animation scroll-right-left">
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="icons">
                                    <img src="/assets/images/testimonial/no.png" alt="Clint Images">
                                </div>
  ...
  <script setup lang="ts">
    useHead({
        ...
        script: [
            ...
            { src: '/assets/js/vendor/magnify.min.js', body: true },
            { src: '/assets/js/vendor/jquery-appear.js', body: true },
            { src: '/assets/js/vendor/backtotop.js', body: true },
            { src: '/assets/js/vendor/isotop.js', body: true },
            { src: '/assets/js/vendor/imageloaded.js', body: true },
            { src: '/assets/js/vendor/wow.js', body: true },
            { src: '/assets/js/vendor/waypoint.min.js', body: true },
            { src: '/assets/js/vendor/easypie.js', body: true },
            { src: '/assets/js/vendor/text-type.js', body: true },
            { src: '/assets/js/vendor/jquery-one-page-nav.js', body: true },
            { src: '/assets/js/vendor/bootstrap-select.min.js', body: true },
            { src: '/assets/js/vendor/jquery-ui.js', body: true },
            { src: '/assets/js/vendor/magnify-popup.min.js', body: true },
            { src: '/assets/js/vendor/paralax-scroll.js', body: true },
            { src: '/assets/js/vendor/paralax.min.js', body: true },
